document.addEventListener('DOMContentLoaded', () => {
    ...
    const rewards = [
        { name: 'Eco-Friendly Tote Bag', cost: 500, img: 'https://i.imgur.com/vHwE52i.png' },
        { name: '$5 Cafe Voucher', cost: 1000, img: 'https://i.imgur.com/KxS2p3P.png' },
        { name: 'Plant a Tree Donation', cost: 1500, img: 'https://i.imgur.com/7gH1zG8.png' },
        { name: 'Reusable Water Bottle', cost: 2000, img: 'https://i.imgur.com/3N0p5b2.png' }
    ];
